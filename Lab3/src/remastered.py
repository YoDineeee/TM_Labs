...
"""def run_splash_screen():
    age = 0
    splash_text = shared_methods.outline_text("GVAD presents....", (255, 255, 255), commons.LARGEFONT)
...
screenshot_img = pygame.image.load("res/images/screenshots/11.png")
                ...
                if Rect(load_menu_box_left1, 120, 336, 384).collidepoint(commons.MOUSE_POS):
                    for i in range(len(commons.WORLD_SAVE_OPTIONS)):
                        if Rect(load_menu_box_left2, 132 + i * 60 + save_select_y_offset, 315, 60).collidepoint(commons.MOUSE_POS):
                            ...
                            text0 = shared_methods.outline_text("", (255, 255, 255), commons.LARGEFONT)
                            text1 = shared_methods.outline_text("", (255, 255, 255), commons.LARGEFONT)
                            text2 = shared_methods.outline_text("", (255, 255, 255), commons.DEFAULTFONT)
