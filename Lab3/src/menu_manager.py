...
def new_title_message():
    ...
    title_message_text = shared_methods.outline_text("", (255, 255, 255), commons.DEFAULTFONT)
...
-----------------------------------------------------------------------------------------------------------------"""
menu_buttons.append(MenuButton("Adventure Time", (commons.WINDOW_WIDTH * 0.5, 30), commons.XLARGEFONT, 25, False, (110, 147, 43), (50, 80, 7)))
...
menu_buttons.append(MenuButton("", (commons.WINDOW_WIDTH * 0.5, 270), commons.LARGEFONT, 25, False))
menu_buttons.append(MenuButton("", (commons.WINDOW_WIDTH * 0.5, 310), commons.LARGEFONT, 25, False))
